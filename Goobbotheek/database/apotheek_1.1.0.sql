...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 09 okt 2017 om 08:05
-- Serverversie: 5.7.14
-- PHP-versie: 5.6.25
...
--
ALTER TABLE `recept`
  ADD CONSTRAINT `fk_Recept_User` FOREIGN KEY (`id`) REFERENCES `user` (`verzekeringsnummer`) ON DELETE NO ACTION ON UPDATE NO ACTION;
